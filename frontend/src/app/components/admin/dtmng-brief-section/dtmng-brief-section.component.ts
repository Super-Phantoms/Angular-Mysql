...
@Component({
  selector: 'app-dtmng-brief-section',
  templateUrl: './dtmng-brief-section.component.html',
  styleUrls: ['./dtmng-brief-section.component.css']
})
export class DtmngBriefSectionComponent {

  @Input() dt_record: any= {
    id: 0,
    title: 'ssss',
    summary: 'xxxxxxxxxxxxxxxxxxxxxxxxx', 
    images: [{title: '', img: ''}],
    media: '',
    catId: 1000,
    gallery: 0
  ...
  @Input() panel_layout_way: any = SolutionViewLayout.only_txt;
  ...
  save_and_uploadFile = () => {
    ...
    var data = {
      ...
      summary: _summary,
      images: _images,
      media: this.dt_record.media,
      catId: this.dt_record.catId,
      gallery: this.dt_record.gallery,
