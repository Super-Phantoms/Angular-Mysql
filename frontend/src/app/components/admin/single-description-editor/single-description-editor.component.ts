...
@Component({
  selector: 'app-single-description-editor',
  templateUrl: './single-description-editor.component.html',
  styleUrls: ['./single-description-editor.component.css']
})
export class SingleDescriptionEditorComponent {
