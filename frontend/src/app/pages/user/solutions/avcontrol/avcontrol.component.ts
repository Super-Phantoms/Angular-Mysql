...
@Component({
  selector: 'app-user-avcontrol',
  templateUrl: './avcontrol.component.html',
  styleUrls: ['./avcontrol.component.scss']
})
export class AVControlComponent implements OnInit , AfterViewInit{
